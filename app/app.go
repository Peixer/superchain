...
import (
	...
	"github.com/Peixer/superchain/docs"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		superchainmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	SuperchainKeeper superchainmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		superchainmoduletypes.StoreKey,
	...
	*/
	...
	app.SuperchainKeeper = *superchainmodulekeeper.NewKeeper(
		...
		app.GetSubspace(superchainmoduletypes.ModuleName),
	)
	superchainModule := superchainmodule.NewAppModule(appCodec, app.SuperchainKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		superchainmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(superchainmoduletypes.ModuleName)
